...
const CORE = ["./", "./index.html", "./style.css", "../style.css", "./app.js?v=2", "./data/terms.json", "./variants.js", "../shared/module-audio.js?v=1", "../shared/module-store.js?v=1", "../module-audio/manifest.json", "../vendor/phosphor/phosphor-regular.css", "../vendor/phosphor/Phosphor.woff2"];
