const CACHE = "ielts-807-v1.3.0-r2";
const CORE = ["./", "./index.html", "./version.json", "./style.css?v=3", "../style.css", "./app.js?v=5", "./priorities.js?v=1", "./data/terms.json", "./data/meanings.json", "./data/priority-rules.json", "../source/807.txt", "./variants.js", "../shared/module-audio.js?v=1", "../shared/module-store.js?v=1", "../module-audio/manifest.json", "../vendor/phosphor/phosphor-regular.css", "../vendor/phosphor/Phosphor.woff2"];
