...
当前版本：Listening `v2.20.0`、Confusions `v1.2.0`、807 `v1.1.0`。807 分支已经整合，运行时只读站内固定词表与 MP3，不再调用第三方词表或系统 TTS。三个独立模块记录均接入备份与写入保护，未增加后台服务。iPhone Safari 实机和全部词的人工发音审听仍未验证。
